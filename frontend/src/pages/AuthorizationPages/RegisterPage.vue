  ...
  <div class="container">
    ...
    <b-form @submit.prevent="onRegister" @reset.prevent="onReset">
      ...
      >
        ...
        >
          Email should be a valid email (i.e example@gmail.com)
        </b-form-invalid-feedback>
      </b-form-group>

      <!-- picture -->
      <b-form-group
        id="input-group-pictureLink"
        label-cols-sm="3"
        label="Picture URL:"
        label-for="pictureLink"
      >
        <b-form-input
          id="pictureLink"
          type="text"
          v-model="$v.form.pictureLink.$model"
          :state="validateState('pictureLink')"
        ></b-form-input>
        <b-form-invalid-feedback
          v-if="!$v.form.pictureLink.required"
        >
          Picture URL is required
        </b-form-invalid-feedback>
        <b-form-invalid-feedback
          v-else-if="!$v.form.pictureLink.url"
        >
          A url only
        </b-form-invalid-feedback>
      </b-form-group>
  ...
  validations: {
    form: {
      username: {
        ...
        alpha,
        // how to check if username is taken already?
      },
      firstname:{
        required,
        alpha
