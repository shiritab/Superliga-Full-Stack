<template>
    <b-col>
        <div class="small-game-preview">
            <b-card>
                <b-card-title id="teams">
                <img :src="hostLogo">
                vs.
                <img :src="guestLogo">
                <div style="float: right">
                    <b-icon-heart v-if="$root.store.username && !favorite" @click="setFavorite" font-scale="1.5"></b-icon-heart>
                    <b-icon-heart-fill v-if="favorite"  font-scale="1.5" variant="danger"></b-icon-heart-fill>
                </div>
                </b-card-title>
...
.small-game-preview .game-title {
  text-align: center;
  text-transform: uppercase;
  color:  rgb(111, 197, 157);
}

.small-game-preview .game-content {
  width: 100%;
  overflow: hidden;
}
